<header class="header">
	<div class="inside clearfix">		
		<nav class="menu-header fleft">
			<ul>            	
				<li><a href="#evento" title="O que é FrontInSampa">O evento</a></li>
				<li><a href="#inscricoes" title="Faça sua inscrição para o FrontInSampa">Inscrições</a></li>
		...
		<div class="bl-logo">
			<h1 class="logo"></h1><a href="index.php" title="Atualizarpágina"><img src="img/logo.png" alt="FrontInSampa" /></a>
		</div>
		<a href="" title="Inscreva-sejá e ganhe uma camiseta do FrontInSampa" class="btn-inscricao fright">Inscreva-sejá e ganhe uma camiseta</a>
	</div>
</header>